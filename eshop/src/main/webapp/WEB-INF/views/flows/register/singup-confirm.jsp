		...
		<!-- Sing Up -->
			<div class="modal-dialog" role="document">
				<div class="modal-content">
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="text-center">
									...
									<h4> ${registerModel.billing.addessLineTwo}</h4>
									
									<h5>City: ${registerModel.billing.city} -  ${registerModel.billing.codePostal}</h5>
									
									<h5>Area: ${registerModel.billing.area}</h5>
					...
					<div class="row">
						<div class="col-ms-4 col-sm-offset-4">
