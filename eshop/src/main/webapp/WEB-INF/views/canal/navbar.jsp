...
<div id="small-dialog1" class="mfp-hide">
	<div class="select-city">
		<h3>
			<i class="fas "> <img src="${images}/12.png" alt=" "
				class="img-fluid">
			</i> Please Select Your Location
		</h3>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" method="post">
					<div class="form-group">
						<label class="col-form-label">Your Name</label> <input type="text"
							class="form-control" placeholder=" " name="Name" required="">
					</div>
					<div class="form-group">
						<label class="col-form-label">Email</label> <input type="email"
			...
			<div class="col-md-3 logo_agile">
				<h1 class="text-center">
					<a href="${contextRoot}/home" class="font-weight-bold font-italic">
						<img src="${images}/14.png" alt=" " class="img-fluid">Affrah
						Shop
					</a>
				</h1>
			</div>
						...
						<div class="wthreecartaits wthreecartaits2 cart cart box_1">
							<form action="#" method="post" class="last">
								...
								<button class="btn " type="submit" name="submit" value="">
									<img src="${images}/2.png" alt=" " class="img-fluid"> <i
										class="font-weight-yellow font-italic">Panier</i>
								</button>
							</form>
						</div>
					</div>
	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="agileits-navi_search">
				<div class="dropdown show" id="agileinfo-nav_search"
								...
								<div class="row">
									<div class="col-sm-6 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="${contextRoot}/products">All Mobile
													Phones</a></li>
											<li><a href="${contextRoot}/products">All Mobile
													Accessories</a></li>
											<li><a href="${contextRoot}/products">Power Banks</a></li>
											<li><a href="${contextRoot}/products">Tablets</a></li>
										</ul>
									</div>
									<div class="col-sm-6 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="${contextRoot}/products">Laptops</a></li>
											<li><a href="${contextRoot}/products">Drives &
													Storage</a></li>
											<li><a href="${contextRoot}/products">Networking
													Devices</a></li>
											<li><a href="${contextRoot}/products">Computer
													Accessories</a></li>
										</ul>
									</div>
								</div>
						...
						<div class="dropdown-menu">
							<div class="agile_inner_drop_nav_info p-4">
								...
								<div class="row">
									...
									<div class="col-sm-6 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="${contextRoot}/checkout" id="checkout">Checkout</a>
											</li>
